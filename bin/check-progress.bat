...
REM kubectl exec -it siacdn-uploader-3 -c sia -- bash -c "echo && echo '------------' && echo 'UPLOADER-3:' && ls -lhtra /tmp/*.zip ; ls -lhtra /etc/sia/**/*.db ; cat /etc/sia/host/host.json 2>/dev/null | grep blockheight 2>/dev/null ; echo '------------' && echo ''"
REM kubectl logs --tail=5 siacdn-uploader-3 -c sia
...
kubectl exec -it siacdn-uploader-5 -c sia -- bash -c "echo && echo '------------' && echo 'UPLOADER-5:' && ls -lhtra /tmp/*.zip ; ls -lhtra /etc/sia/**/*.db ; cat /etc/sia/host/host.json 2>/dev/null | grep blockheight 2>/dev/null ; echo '------------' && echo ''"
kubectl logs --tail=5 siacdn-uploader-5 -c sia
...
kubectl exec -it siacdn-viewer-3 -c sia -- bash -c "echo && echo '------------' && echo 'VIEWER-3:' && ls -lhtra /tmp/*.zip ; ls -lhtra /etc/sia/**/*.db ; cat /etc/sia/host/host.json 2>/dev/null | grep blockheight 2>/dev/null ; echo '------------' && echo ''"
kubectl logs --tail=5 siacdn-viewer-3 -c sia